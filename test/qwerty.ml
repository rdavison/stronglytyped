...
let%expect_test "check qwerty stats" =
  ...
  [%expect
    ...
    │    (top)       roll     0.00  0.00  0.00 │
    │ (middle)       roll     0.00  0.00  0.00 │
    │ (bottom)       roll     0.00  0.00  0.00 │
    │    (top)  (in) roll     0.00  0.00  0.00 │
    │ (middle)  (in) roll     0.00  0.00  0.00 │
    │ (bottom)  (in) roll     0.00  0.00  0.00 │
    │    (top) (out) roll     0.00  0.00  0.00 │
    │ (middle) (out) roll     0.00  0.00  0.00 │
    │ (bottom) (out) roll     0.00  0.00  0.00 │
    └──────────────────────────────────────────┘ |}]
;;
